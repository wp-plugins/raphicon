...
Is a Bootstrap 3.3.4 Glyphicon or Wordpress Dashicons icon library that allo you to insert it into post/page on a shortcode and customizable size and/or color.
...
1. RAphicon Button at Editor Toolbar
2. Icons Libraries
3. Custom attribute
